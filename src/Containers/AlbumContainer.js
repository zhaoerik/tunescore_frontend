            ...
            { props.user ?
                <Switch>
                    <Route path={'/albums/:id'} render={(routerProps) => {
                        ...
                        return (<AlbumStats albums={props.albums} tracks={trackApi} key={foundAlbum.id} album={foundAlbum} user={props.user} users={props.users} reviews={props.reviews} newReview={props.newReview} deleteReview={props.deleteReview} setSearch={setSearch} />)
                    }} />
